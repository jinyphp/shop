<x-www-layout>
    ...
    <!-- breadcrumb -->
    @livewire('ShopProductBreadcrumb',['slug'=>$slug ,'admin'=>$admin])
    ...
    <main class="mx-auto" style="width:1280px;">
        <div class="flex justify-between items-start ">
            ...
            <div class="w-64 pr-8 mr-8" style="width:264px">
                ...
                {{--
                <!-- 사이드 카테고리 -->
                @include('jiny-shop::shop.category.sidebar')
            ...
            <div class="flex-1">
                ...
                @if($cate)
                    <div>카테고리</div>
                    @livewire('ShopProductList',['cate'=>$cate, 'category_id'=>$cate['id'], 'cartidx'=>$cartidx])
