<div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-6">
        ...
        <div class="flex justify-between items-start">
            <div class="w-32">
                <a href="/shop/detail/{{$popular->id}}" title="{{$popular->name}}">
                    <figure>
            ...
            <div class="flex-1">
                <a href="/shop/detail/{{$popular->id}}" class="block font-semibold text-gray-600 hover:text-gray-500">
                    {{$popular->name}}
                </a>
                <div class="text-gray-500 font-medium">
                    ${{$popular->regular_price}}
                </div>
            </div>
        </div>
        @endforeach
