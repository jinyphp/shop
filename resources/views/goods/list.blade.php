<div>
    ...
    <!--wrap shop control-->
    {{-- class="wrap-shop-control" --}}
    <div class="flex items-center p-2 bg-gray-300 mb-8">
        <div class="flex-1">
        ...
        <div class="change-display-mode">
            <a href="#" class="grid-mode display-mode active" wire:click="displayGrid">
                <i class="fa fa-th"></i>
                Grid
            </a>
            <a href="#" class="list-mode display-mode" wire:click="displayList">
