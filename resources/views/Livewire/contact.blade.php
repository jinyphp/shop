						...
						<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
							<div class="contact-box contact-form">
								...
								<form wire:submit.prevent="store">
									...
									<input type="text" value="" id="name" name="name" wire:model="forms.name">

									<label for="email">Email<span>*</span></label>
									<input type="text" value="" id="email" name="email"  wire:model="forms.email">

									<label for="phone">Number Phone</label>
									<input type="text" value="" id="phone" name="phone"  wire:model="forms.phone">

									<label for="comment">Comment</label>
									<textarea name="comment" id="comment"  wire:model="forms.comment"></textarea>
