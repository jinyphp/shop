...
class AdminUserMoneyHistoryController extends ResourceController
{
    public function __construct()
    {
        ...
        $this->actions['view_list'] = "jiny-shop::admin.user_money_history.list";
        $this->actions['view_form'] = "jiny-shop::admin.user_money_history.form";
